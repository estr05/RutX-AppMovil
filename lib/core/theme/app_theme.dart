...
class AppTheme {
  ...
  static const Color primaryColor = Color(
    0xFF003B5C,
  ); // Dark Blue - Fondo AppBar, headers
  static const Color accentColor = Color(
    0xFFFF6A13,
  ); // Orange - Botones primarios, totales, accentos
  static const Color secondaryColor = Color(
    0xFFA8C8E9,
  ); // Light Blue - Fondos secundarios, seleccion
  ...
  static const Color bgDark = Color(
    0xFF003B5C,
  ); // Mismo que primary, fondos oscuros
  static const Color surfaceCard =
      Colors.white; // Tarjetas (SaleCard, SummaryMetrics, TicketCard)
  ...
  static const Color borderLight = Color(
    0xFFE0E0E0,
  ); // Bordes de tarjetas, separadores
  static const Color borderAccent = Color(
    0xFFFFE0B2,
  ); // Borde accent suave (botones outline)
  ...
  // ───────────────────────────────────────────────────────────────────────────
  static const Color alertSuccessBg = Color(
    0xFFE8F5E9,
  ); // Fondo exito (check verde claro)
  static const Color alertErrorBg = Color(
    0xFFFFEBEE,
  ); // Fondo error (rojo claro)
  static const Color alertWarningBg = Color(
    0xFFFFF8E1,
  ); // Fondo advertencia (amarillo claro)
  static const Color alertWarningText = Color(
    0xFF795500,
  ...
  // ───────────────────────────────────────────────────────────────────────────
  static const Color accentBgLight = Color(
    0xFFFFF3E0,
  ); // Fondo accent muy claro (botones outline)
  static const Color accentBorder = Color(
    0xFFFFE0B2,
  ); // Borde accent suave (outline buttons)
  static const Color accent10 = Color(
    0x1AFF6A13,
  ); // accentColor al 10% (fondos hover)
  ...
  static const Color primaryLightBg = Color(
    0xFFE3F2FD,
  ); // Fondo azul claro (info cards)
  static const Color primaryDarkText = Color(
    0xFF005691,
  ); // Texto azul oscuro (charts)
  ...
  // ───────────────────────────────────────────────────────────────────────────
  static const Color surfaceGrey100 = Color(
    0xFFF5F5F5,
  ); // Gris muy claro (fondos de search, inputs)
  static const Color surfaceGrey = Color(
    0xFF9E9E9E,
  ); // Gris medio (bordes, iconos secundarios)
  ...
  static const Color black08 = Color(
    0x14000000,
  ); // Colors.black al 8% (sombras ticket)
  static const Color textPrimary05 = Color(0x0D343D45); // textPrimary al 5%
  static const Color textSecondary50 = Color(
    0x80B0B0B0,
  ); // textSecondary al 50%
  static const Color borderLight50 = Color(0x80E0E0E0); // borderLight al 50%
  static const Color secondaryColor60 = Color(
    0x99A8C8E9,
  ); // secondaryColor al 60% (version info)

  // ───────────────────────────────────────────────────────────────────────────
  // SURFACE ACCENT LIGHTER (Variante aun mas clara de accentColor)
  // ───────────────────────────────────────────────────────────────────────────
  static const Color accentBgLighter = Color(
    0xFFFFF9F2,
  ); // Fondo accent clarisimo (search field)
