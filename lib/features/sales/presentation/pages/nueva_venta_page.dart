...
class _NuevaVentaPageState extends State<NuevaVentaPage>
  ...
  int _formaCobroId = 67; // 67=Efectivo, 71=Credito
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: quiereAbonar
                                  ? AppTheme.statusGreen
                                  : AppTheme.accentBgLight,
                              foregroundColor: quiereAbonar
                                  ? AppTheme.textWhite
                    ...
                    Form(
                      ...
                      child: TextFormField(
                        ...
                        validator: (v) {
                          ...
                          if (val > total) return 'El abono no puede exceder el total';
                          return null;
                        },
                      ),
                    ),
  ...
  void _confirmSale() async {
    ...
    final subtotalSinIva = _getCartTotal(); // precio base sin IVA (para el ticket)
    ...
    if (mounted) {
      ...
      if (isOnline) {
        ...
        if (isConnected) {
          showInfo(context, 'Venta guardada localmente. Se sincronizara automaticamente.');
        } else {
          showInfo(context, 'Sin conexion. La venta se enviara al recuperar senal.');
        }
      }
  ...
  Widget build(BuildContext context) {
    ...
    final initials = (names.length > 1 && names[0].isNotEmpty && names[1].isNotEmpty)
        ? '${names[0][0]}${names[1][0]}'.toUpperCase()
        : widget.cliente.nombreCliente.substring(0, min(2, widget.cliente.nombreCliente.length)).toUpperCase();
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return RepaintBoundary(
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:
                                            hasQty                                                 ? AppTheme.accentBgLighter
                            ...
                            children: [
                                ...
                                children: [
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () => setState(() => _formaCobroId = 67),
                                      child: Container(
                                        padding: const EdgeInsets.symmetric(vertical: 12),
                                        decoration: BoxDecoration(
                                          color: _formaCobroId == 67
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () => setState(() => _formaCobroId = 71),
                                      child: Container(
                                        padding: const EdgeInsets.symmetric(vertical: 12),
                                        decoration: BoxDecoration(
                                          color: _formaCobroId == 71
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            'Este cliente ya no puede vender a crédito: saldo \$${widget.cliente.saldo.toStringAsFixed(2)} de límite \$${widget.cliente.limiteCredito.toStringAsFixed(2)}. El servidor rechazará la venta.',
                                            style: const TextStyle(
                                              color: AppTheme.statusRed,
                                              fontSize: 12,
                                              fontWeight: FontWeight.bold,
                              ...
                              if (widget.cliente.saldo > 0 &&
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(top: 8),
                                  child: Text(
                                    'Saldo pendiente: \$${widget.cliente.saldo.toStringAsFixed(2)}',
                                    style: const TextStyle(
