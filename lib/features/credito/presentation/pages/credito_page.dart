...
class CreditoPage extends StatefulWidget {
  const CreditoPage({Key? key}) : super(key: key);
...
class _CreditoPageState extends State<CreditoPage> {
  ...
  Color _pctColor(double usado) {
    return usado > 80 ? AppTheme.statusRed : usado > 50 ? AppTheme.statusOrange : AppTheme.statusGreen;
  }
      ...
      body: Column(
        children: [
          Container(
            ...
            padding: EdgeInsets.only(top: topPadding + 16, bottom: 24, left: 16, right: 16),
                    ...
                    : RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final limite = (c['limite_credito'] as num?)?.toDouble() ?? 0.0;
                            final usado = (c['porcentaje_usado'] as num?)?.toDouble() ?? 0.0;
                            final docsPend = c['documentos_pendientes'] as int? ?? 0;
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      _Metric(label: 'Saldo', value: '\$${saldo.toStringAsFixed(2)}', isPrimary: true),
                                      _Metric(label: 'Límite', value: '\$${limite.toStringAsFixed(2)}'),
                                    ...
                                    child: OutlinedButton.icon(
                                      onPressed: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (_) => CobranzaPagoPage(
                                              clienteId: c['cliente_id'] as int,
                                      ...
                                      label: const Text('COBRAR', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700)),
...
class _Metric extends StatelessWidget {
  ...
  const _Metric({required this.label, required this.value, this.isPrimary = false});
        ...
        children: [
          ...
          Text(
            ...
            style: textTheme.titleSmall?.copyWith(
              ...
              color: isPrimary ? colorScheme.onSurface : colorScheme.onSurfaceVariant,
            ),
          ),
        ],
      ),
